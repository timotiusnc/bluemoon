...
import bgHero from '@/images/hero/main.jpg'
...
export function Hero() {
  return (
    <Container className="pb-20 text-center">
      ...
      <div className="rounded-lg bg-white/50 px-5 py-10 backdrop-blur-[5px] lg:bg-white/40 lg:backdrop-blur-sm">
        ...
        <h2 className="mx-auto mt-6 max-w-2xl font-display text-xl font-semibold text-cyan-950 lg:text-3xl">
          Natural & Lab Grown Diamond
        </h2>
        <p className="mx-auto mt-6 max-w-2xl text-sm tracking-tighter text-cyan-950 lg:text-lg">
