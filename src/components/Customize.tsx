...
export function CustomizeWithUs() {
  return (
    <section id="customize" aria-label="Customize with us" className="py-10">
      <Container className="flex flex-col items-center gap-16 lg:flex-row">
        <Image
          src={customize}
          alt="Customize with us"
          className="max-h-[300px] max-w-[300px] flex-shrink rounded-lg object-cover shadow-2xl lg:min-h-[400px] lg:max-w-[600px]"
        />
